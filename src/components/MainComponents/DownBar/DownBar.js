...
export default function DownBar() {
    return (
        <div className="containerDiv">
            <NavLink activeClassName="childDivActive" className="childDiv glassmorphism" to="/courses">
                ...
                <span className="childSpan">
                    <span role="img" aria-label="emoji">
                        &nbsp;
                    </span>
                    COURSES
                </span>
                <span className="childSpanMobile">
                    Courses
                </span>
            </NavLink>
            <a target="_blank" className="childDiv glassmorphism" href="https://free-for.dev/#/" rel="noopener noreferrer">
            ...
            <NavLink exact activeClassName="childDivActive" className="childDiv glassmorphism" to="/">
            ...
            <NavLink activeClassName="childDivActive" className="childDiv glassmorphism" to="/competitive">
            ...
            <NavLink activeClassName="childDivActive" className="childDiv glassmorphism" to="/blogs">
