...
export default function Home() {
    ...
    const cseNotesLink = cseNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const itNotesLink = itNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const eceNotesLink = eceNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const civilNotesLink = civilNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const mechNotesLink = mechNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const eeeNotesLink = eeeNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const mcaNotesLink = mcaNotes.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const quePaperLinks = QuePaperList.map(listItem =>
        <a className={styles.aStyle}
            title={listItem.name}
            key={listItem.link}
            href={listItem.link}
    ...
    const booksLinks = BooksList.map(listItem =>
        <a className={styles.aStyle}
